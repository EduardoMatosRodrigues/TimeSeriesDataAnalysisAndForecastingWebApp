...
class SimpleExponentialSmoothing(MathematicalToolInterface):
    ...
    def _set_explanation(self):
        ...
        self.explanation = "The Simple Exponential Smoothing is a time series forecasting method for univariate data without trend or seasonality (stationary data)"
