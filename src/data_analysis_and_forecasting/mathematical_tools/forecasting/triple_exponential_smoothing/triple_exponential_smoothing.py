...
class TripleExponentialSmoothing(MathematicalToolInterface):
    ...
    def _set_explanation(self):
        ...
        self.explanation = "The Triple Exponential Smoothing is a time series forecasting method for univariate data with trend or seasonality"
    ...
    def _set_results(self):
        ...
        fitted_data = fitted_model.fittedvalues
